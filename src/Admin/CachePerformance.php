...
class CachePerformance {
	...
	private function run_performance_benchmark(): void {
		...
		$message = sprintf(
			__( 'Benchmark completato. Miglioramento performance: %1$.2f%%, Cache hit ratio: %2$.2f%%', 'fp-digital-marketing' ),
	...
	private function run_load_test(): void {
		...
		$message = sprintf(
			__( 'Test di carico completato. Richieste totali: %1$d, Tempo medio risposta: %2$.4fs', 'fp-digital-marketing' ),
	...
	private function run_memory_test(): void {
		...
		$message = sprintf(
			__( 'Test memoria completato. Efficienza cache: %1$.2f, Memoria utilizzata: %2$s', 'fp-digital-marketing' ),
