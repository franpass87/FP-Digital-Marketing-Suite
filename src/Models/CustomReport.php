...
class CustomReport {
	...
	public function send_via_email( string $content, string $format, string $filename ): bool {
		...
		$client_name = $this->get_client_name();
		$subject = sprintf(
			__( 'Report %s - %s', 'fp-digital-marketing' ),
			$this->report_name,
			$client_name
		);

		$message = sprintf(
			__( 'In allegato trovi il report "%s" per il cliente %s.', 'fp-digital-marketing' ),
			$this->report_name,
			$client_name
		) . "\n\n";
	...
	public function get_report_name(): string { return $this->report_name; }
	public function get_report_description(): string { return $this->report_description; }
	public function get_time_period(): string { return $this->time_period; }
	public function get_selected_kpis(): array { return $this->selected_kpis; }
	public function get_report_frequency(): string { return $this->report_frequency; }
	public function get_email_recipients(): array { return $this->email_recipients; }
	public function is_auto_send(): bool { return $this->auto_send; }
	public function get_status(): string { return $this->status; }

	public function set_client_id( int $client_id ): void { $this->client_id = $client_id; }
	public function set_report_name( string $report_name ): void { $this->report_name = $report_name; }
	public function set_report_description( string $report_description ): void { $this->report_description = $report_description; }
	public function set_time_period( string $time_period ): void { $this->time_period = $time_period; }
	public function set_selected_kpis( array $selected_kpis ): void { $this->selected_kpis = $selected_kpis; }
	public function set_report_frequency( string $report_frequency ): void { $this->report_frequency = $report_frequency; }
	public function set_email_recipients( array $email_recipients ): void { $this->email_recipients = $email_recipients; }
	public function set_auto_send( bool $auto_send ): void { $this->auto_send = $auto_send; }
