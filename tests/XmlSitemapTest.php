...
class XmlSitemapTest extends TestCase {
	...
	public function test_generate_sitemap_index(): void {
		...
		$wp_mock_functions['get_posts'] = function( $args ) {
			if ( isset( $args['numberposts'] ) && $args['numberposts'] === 1 ) {
				// For lastmod query
				return [ (object) [ 'ID' => 1, 'post_modified_gmt' => '2024-01-15 10:30:00' ] ];
			}
			return [];
		};
		...
		$wp_mock_functions['wp_cache_get'] = function() { return false; };
		$wp_mock_functions['get_transient'] = function() { return false; };
	...
	public function test_update_settings(): void {
		...
		$wp_mock_functions['wp_cache_delete'] = function() { return true; };
