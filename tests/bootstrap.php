...
$env_wp_version = getenv( 'FP_DMS_WP_VERSION' );
if ( ! defined( 'WP_VERSION' ) && false !== $env_wp_version && '' !== $env_wp_version ) {
        define( 'WP_VERSION', $env_wp_version );
}
/**
